...
{
    public static string GetJa(this ErrorCode code)
    {
        return code switch
        {
            ...
            ErrorCode.SetBorrowAmountFailed => "借入残額の上書きに失敗しました。",
            ...
            ErrorCode.BorrowAmountMustBeZeroOrGreater => "借入残額は 0 以上で指定してください。",
