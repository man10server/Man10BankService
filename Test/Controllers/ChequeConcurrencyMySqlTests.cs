...
// 小切手使用の並行整合性検証(DESIGN 4.1 / 2.3)。本番と同じ MySQL(Testcontainers)上で、
// 同一小切手を多数同時に使用しても cheque 行ロックにより成功は1件のみで、
// 受取人残高への二重入金が起きないことを確認する。
[Collection(MySqlCollection.Name)]
public class ChequeConcurrencyMySqlTests
{
